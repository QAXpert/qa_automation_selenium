...
public class assert_selenium {
    ...
    public void localizarElementosHard() {
        ...
        Assert.assertEquals(elementoId.getText(), "Testing Web", "El elemento del titulo con corresponde al esperado");
    ...
    public void localizarElementosSoft() {
        ...
        // By.id
        WebElement elementoId = driver.findElement(By.id("titulo"));
        softAssert.assertEquals(elementoId.getText(), "Testing Web","el titulo con coinciden");

        // By.name
        WebElement elementoName = driver.findElement(By.name("username"));
        softAssert.assertEquals(elementoName.getAttribute("type"), "tex", "El valor del atributo 'value' no coincide");
